...
time elapsed=0.005,    comparisons:          4,    swaps:          1
statistics for quick_sort
time elapsed=0.005,    comparisons:         13,    swaps:          3

/*Podemos ver que un arreglo ordenado, quick sort es el mas eficiente


/*example-unsorted.in  statistics for selection_sort
time elapsed=0.037,    comparisons:         10,    swaps:          5
statistics for insertion_sort
time elapsed=0.004,    comparisons:          7,    swaps:          5
statistics for quick_sort
time elapsed=0.004,    comparisons:          8,    swaps:          4
/*En este caso, quick e insertion parecen eficientes, pero insertion hace menos comparaciones. 
