...
int main(int argc, char *argv[]) {
    ...
    int min = temperatura_minima(array);
    printf("\nLa temperatura minima registrada es de: %d", min);

    int output[YEARS];
    month_t output2[YEARS];
    char *month;

    maximaTemp(array, output);
    for(unsigned int year = 0; year < YEARS; year++) {
        printf("\nLa temperatura máxima del año %u es: %d\n", year + 1980, output[year]);
    }

    max_precipitaciones(array, output2);
    ...
    for(unsigned int year = 0; year < YEARS; year++) {
        ...
        printf("El mes con mas precipitacion del anio %d son: %s\n", year + 1980, month);
    }
