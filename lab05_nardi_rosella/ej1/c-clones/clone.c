...
//El valor de length es 1812.
//El problema es que estabamos tratando de modificar una variable en memoria global. Es
//por eso que es necesario utilizar la memoria dinamica en string_clone.