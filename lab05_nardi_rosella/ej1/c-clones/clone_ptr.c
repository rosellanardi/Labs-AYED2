...
/*Si string_clone recibe length como el tamaño de la cadena calculado co
 sizeof(original) / sizeof(*original)
 Con char *original = ""; dará un resultado incorrecto porque sizeof(original) es el tamaño 
 del puntero, no de la cadena.*/